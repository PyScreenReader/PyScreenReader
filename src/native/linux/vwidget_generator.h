...
// button
const std::string BUTTON_ROLE_ID = "button";
const std::string PUSH_BUTTON_ROLE_ID = "push button";
const std::string CHECK_BOX_ROLE_ID = "check box";
const std::string COMBO_BOX_ROLE_ID = "combo box";
const std::string RADIO_BUTTON_ROLE_ID = "radio button";

// text
const std::string ENTRY_ROLE_ID = "entry";
const std::string TEXT_ROLE_ID = "text";
const std::string LABEL_ROLE_ID = "label";
const std::string HEADING_ROLE_ID = "heading";

// menu
const std::string PUSH_BUTTON_MENU_ROLE_ID = "push button menu";
const std::string MENU_ITEM_ROLE_ID = "menu item";
const std::string MENU_ROLE_ID = "menu";
const std::string MENU_BAR_ROLE_ID = "menu bar";

// window
const std::string FRAME_ROLE_ID = "frame";
const std::string APPLICATION_ROLE_ID = "application";

// grouping
const std::string TABLE_ROW_ROLE_ID = "table row";
const std::string TABLE_COLUMN_HEADER_ROLE_ID = "table column header";
const std::string LIST_ROLE_ID = "list";
const std::string GROUPING_ROLE_ID = "grouping";
const std::string TREE_ROLE_ID = "tree";
const std::string TABLE_CELL_ROLE_ID = "table cell";
const std::string SCROLL_PANE_ROLE_ID = "scroll pane";

// unknown
const std::string UNKNOWN_ROLE_ID = "unknown";

const std::unordered_map<
    std::string,
    std::function<std::shared_ptr<VirtualWidget>(AtspiAccessible *)>>
    ROLE_TO_VWIDGET_MAP = {{BUTTON_ROLE_ID,
                            [](AtspiAccessible *e) {
                           ...
                           {UNKNOWN_ROLE_ID, [](AtspiAccessible *e) {
