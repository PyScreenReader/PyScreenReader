...
void BindVirtualGroupWidget(py::module_ &module) {
    py::class_<VirtualGroupWidget, VirtualWidget, std::shared_ptr<VirtualGroupWidget>>(module, "VirtualGroupWidget")
            .def(py::init())
            .def("getWidgetName", &VirtualGroupWidget::GetWidgetName)
            .def("isClickable", &VirtualGroupWidget::IsClickable);
}

REGISTER_BINDING("VirtualGroupWidget", BindVirtualGroupWidget, "VirtualWidget")